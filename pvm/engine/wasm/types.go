...
import (
	"fmt"
	"io"
	"paradigm-vm/pvm/engine/wasm/leb128"
)

//define via webassembly. see :https://webassembly.org/docs/binary-encoding/
...
//Webassembly just can support 4 types. Those can combine some complex types.
